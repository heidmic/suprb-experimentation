...
def load_forest_fires(return_X_y: bool = True, as_frame: bool = False):
    ...
    return load_dataset(filename="forest_fires.csv", target_column="area", return_X_y=return_X_y, as_frame=as_frame)
...
def load_parkinson_total(return_X_y: bool = True, as_frame: bool = False):
    ...
    return load_dataset(
        ...
        as_frame=as_frame,
        remove_columns=["subject#", "test_time", "motor_UPDRS"],
    )
...
def load_parkinson_motor(return_X_y: bool = True, as_frame: bool = False):
    ...
    return load_dataset(
        ...
        return_X_y=return_X_y,
        as_frame=as_frame,
        remove_columns=["subject#", "test_time", "total_UPDRS"],
    )
