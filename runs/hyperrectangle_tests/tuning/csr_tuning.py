...
def csr_space(trial: Trial, params: Bunch):
    ...
    # Unique to CSR
    params.rule_discovery__mutation__sigma = np.array([trial.suggest_float('sigma_mutate_center', *sigma_space),
    ...
    if isinstance(params.rule_discovery__init, rule.initialization.NormalInit):
        # Unique to CSR
        params.rule_discovery__init__sigma = np.array([trial.suggest_float('sigma_init_center', *sigma_space),
