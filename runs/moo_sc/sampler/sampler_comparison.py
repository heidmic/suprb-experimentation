...
def run(problem: str, job_id: str, optimizer: str, config: str):
    ...
    def suprb_ES_MOO_space(trial: Trial, params: Bunch):
        ...
        if config in ("beta_equi_tuned", "beta_proj_tuned"):
            params.solution_composition__sampler__a = trial.suggest_float("solution_composition__sampler__a", 0.1, 10)
            params.solution_composition__sampler__b = trial.suggest_float("solution_composition__sampler__b", 0.1, 10)
