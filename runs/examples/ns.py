import mlflow
import numpy as np
import suprb.rule.initialization
from optuna import Trial
from sklearn.ensemble import RandomForestRegressor
from sklearn.model_selection import train_test_split
from sklearn.utils import Bunch
from skopt.space import Integer, Real
from suprb import optimizer, SupRB, rule
...
def run(problem: str):
    ...
    estimator = SupRB(rule_generation=ns.NoveltySearch(init=rule.initialization.HalfnormInit()),
    ...
    def optuna_objective(trial: optuna.Trial, params: Bunch):
        ...
        params.rule_generation__selection = trial.suggest_categorical('selection', ['RouletteWheel', 'Random'])
        ...
        if isinstance(params.rule_generation__novelty_calculation__novelty_search_type, optimizer.rule.ns.novelty_search_type.MinimalCriteria):
        ...
        elif isinstance(params.rule_generation__novelty_calculation__novelty_search_type, optimizer.rule.ns.novelty_search_type.LocalCompetition):
        ...
        params.rule_generation__novelty_calculation__novelty_search_type = getattr(
            optimizer.rule.ns.novelty_search_type, params.rule_generation__novelty_calculation__novelty_search_type)()
        ...
        params.rule_generation__novelty_calculation__archive = getattr(
            optimizer.rule.ns.archive, params.rule_generation__novelty_calculation__archive)()
        ...
        if isinstance(params.rule_generation__novelty_calculation, optimizer.rule.ns.novelty_calculation.NoveltyFitnessBiased):
        ...
        params.rule_generation__novelty_calculation = getattr(
            optimizer.rule.ns.novelty_calculation, params.rule_generation__novelty_calculation)()

        # GA
        params.solution_composition__selection = trial.suggest_categorical(
            'ga_selection', ['RouletteWheel', 'Tournament', 'LinearRank', 'Random'])
