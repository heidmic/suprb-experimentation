...
>>>>>>> merge_this
        ...
        if params.rule_discovery == "ES1xLambda":
            ...
            params.rule_discovery__novelty_calculation = trial.suggest_categorical(
                "rule_discovery__novelty_calculation",
...
>>>>>>> merge_this
                ...
                params.rule_discovery__novelty_calculation__novelty_bias = trial.suggest_float(
                    "rule_discovery__novelty_calculation__novelty_bias", 0.1, 0.9
                )  # nopep8
            else:
                params.rule_discovery__novelty_calculation__k_neighbor = trial.suggest_int(
                    "rule_discovery__novelty_calculation__k_neighbor", 10, 20
                )  # nopep8

            params.rule_discovery__novelty_calculation__archive = trial.suggest_categorical(
                "rule_discovery__novelty_calculation__archive", ["ArchiveNovel", "ArchiveRandom", "ArchiveNone"]
            )  # nopep8
...
<<<<<<< HEAD
                "rule_discovery__novelty_calculation__novelty_search_type", ["NoveltySearchType", "MinimalCriteria", "LocalCompetition"]
            )  # nopep8
...
=======
                "rule_discovery__novelty_calculation__novelty_search_type",
                ["NoveltySearchType", "MinimalCriteria", "LocalCompetition"],
            )  # nopep8
            params.rule_discovery__novelty_calculation__novelty_search_type = getattr(
                suprb.optimizer.rule.ns.novelty_search_type,
...
>>>>>>> merge_this
        ...
        params.rule_discovery__init = trial.suggest_categorical(
            "rule_discovery__init", ["MeanInit", "NormalInit", "HalfnormInit"]
        )  # nopep8
...
<<<<<<< HEAD
                "rule_discovery__mutation", ["SigmaRange", "Normal", "Halfnorm", "HalfnormIncrease", "Uniform", "UniformIncrease"]
            )  # nopep8
            ...
            if isinstance(params.rule_discovery__mutation, suprb.optimizer.rule.mutation.SigmaRange):
                params.rule_discovery__mutation__mutation = trial.suggest_categorical(
                    "rule_discovery__mutation__mutation", ["Normal", "Halfnorm", "HalfnormIncrease", "Uniform", "UniformIncrease"]
=======
...
>>>>>>> merge_this
                ...
                params.rule_discovery__mutation__mutation = getattr(
                    suprb.optimizer.rule.mutation, params.rule_discovery__mutation__mutation
                )()  # nopep8

                params.rule_discovery__mutation__low = trial.suggest_float(
                    "rule_discovery__mutation__sigma_range__low", 0.001, 0.01
                )  # nopep8
                params.rule_discovery__mutation__high = trial.suggest_float(
                    "rule_discovery__mutation__sigma_range__high", 0.01, 0.1
                )  # nopep8

                params.rule_discovery__mutation__mutation__sigma = trial.suggest_float(
...
<<<<<<< HEAD
            ...
            params.rule_discovery__origin_generation = trial.suggest_categorical(
                "rule_discovery__origin_generation", ["UniformInputOrigin", "UniformSamplesOrigin", "Matching", "SquaredError"]
=======
            ...
            params.rule_discovery__origin_generation = trial.suggest_categorical(
                ...
                ["UniformInputOrigin", "UniformSamplesOrigin", "Matching", "SquaredError"],
>>>>>>> merge_this
            )  # nopep8
            ...
            if isinstance(params.rule_discovery__mutation, suprb.optimizer.rule.origin.Matching) or isinstance(
                params.rule_discovery__mutation, suprb.optimizer.rule.origin.SquaredError
            ):
                params.rule_discovery__origin_generation__use_elitist = trial.suggest_categorical(
                    "rule_discovery__origin_generation__use_elitist", [True, False]
                )  # nopep8

        params.solution_composition = trial.suggest_categorical(
...
>>>>>>> merge_this
            ...
            params.solution_composition__init__mixing__experience_calculation = getattr(
                suprb.solution.mixing_model, params.solution_composition__init__mixing__experience_calculation
            )()  # nopep8

            if isinstance(
                params.solution_composition__init__mixing__experience_calculation,
                suprb.solution.mixing_model.CapExperienceWithDimensionality,
            ):
            ...
            params.solution_composition__init__mixing__filter_subpopulation = getattr(
                suprb.solution.mixing_model, params.solution_composition__init__mixing__filter_subpopulation
            )()  # nopep8

            params.solution_composition__init__mixing__filter_subpopulation__rule_amount = trial.suggest_int(
                "solution_composition__init__mixing__filter_subpopulation__rule_amount", 4, 10
            )  # nopep8

            # GA selection
            params.solution_composition__selection = trial.suggest_categorical(
                "solution_composition__selection", ["Random", "RouletteWheel", "LinearRank", "Tournament"]
            )  # nopep8
            params.solution_composition__selection = getattr(
                suprb.optimizer.solution.ga.selection, params.solution_composition__selection
            )()  # nopep8
...
>>>>>>> merge_this
            ...
            params.solution_composition__crossover = getattr(
                suprb.optimizer.solution.ga.crossover, params.solution_composition__crossover
            )()  # nopep8
