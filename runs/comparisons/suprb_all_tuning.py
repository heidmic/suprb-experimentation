...
def run(problem: str, job_id: str, study_name: str):
    ...
    def suprb_space(trial: Trial, params: Bunch):
        ...
        if params.rule_discovery == 'ES1xLambda':
            # ES base
            params.rule_discovery = getattr(suprb.optimizer.rule.es, params.rule_discovery)()

            params.rule_discovery__operator = trial.suggest_categorical('rule_discovery__operator', ['&', ',', '+'])
            ...
            if params.rule_discovery__operator == '&':
                params.rule_discovery__delay = trial.suggest_int('rule_discovery__delay', 20, 50)
        elif params.rule_discovery == 'NoveltySearch':
            # NS base
            params.rule_discovery = getattr(suprb.optimizer.rule.ns, params.rule_discovery)()

            params.rule_discovery__lmbda = trial.suggest_int('rule_discovery__lmbda', 100, 200)
            params.rule_discovery__mu = trial.suggest_int('rule_discovery__mu', 10, 20)
            params.rule_discovery__n_elitists = trial.suggest_int('rule_discovery__n_elitists', 5, 20)
            params.rule_discovery__n_iter = trial.suggest_int('rule_discovery__n_iter', 5, 15)
            params.rule_discovery__roh = trial.suggest_int('rule_discovery__roh', 10, 20)

            # NS novelty_calculation
            params.rule_discovery__novelty_calculation = trial.suggest_categorical('rule_discovery__novelty_calculation', ['NoveltyCalculation', 'ProgressiveMinimalCriteria', 'NoveltyFitnessPareto', 'NoveltyFitnessBiased'])  # nopep8
            params.rule_discovery__novelty_calculation = getattr(suprb.optimizer.rule.ns.novelty_calculation, params.rule_discovery__novelty_calculation)()  # nopep8

            if isinstance(params.rule_discovery__novelty_calculation, suprb.optimizer.rule.ns.novelty_calculation.NoveltyFitnessBiased):  # nopep8
                params.rule_discovery__novelty_calculation__novelty_bias = trial.suggest_float('rule_discovery__novelty_calculation__novelty_bias', 0.1, 0.9)  # nopep8
            else:
                params.rule_discovery__novelty_calculation__k_neighbor = trial.suggest_int('rule_discovery__novelty_calculation__k_neighbor', 10, 20)  # nopep8

            params.rule_discovery__novelty_calculation__archive = trial.suggest_categorical('rule_discovery__novelty_calculation__archive', ['ArchiveNovel', 'ArchiveRandom', 'ArchiveNone'])  # nopep8
            params.rule_discovery__novelty_calculation__archive = getattr(suprb.optimizer.rule.ns.archive, params.rule_discovery__novelty_calculation__archive)()  # nopep8

            params.rule_discovery__novelty_calculation__novelty_search_type = trial.suggest_categorical('rule_discovery__novelty_calculation__novelty_search_type', ['NoveltySearchType', 'MinimalCriteria', 'LocalCompetition'])  # nopep8
            params.rule_discovery__novelty_calculation__novelty_search_type = getattr(suprb.optimizer.rule.ns.novelty_search_type, params.rule_discovery__novelty_calculation__novelty_search_type)()  # nopep8

            if isinstance(params.rule_discovery__novelty_calculation__novelty_search_type, suprb.optimizer.rule.ns.novelty_search_type.MinimalCriteria):  # nopep8
                params.rule_discovery__novelty_calculation__novelty_search_type__min_examples_matched = trial.suggest_int('rule_discovery__novelty_calculation__novelty_search_type__min_examples_matched', 10, 20)  # nopep8
            elif isinstance(params.rule_discovery__novelty_calculation__novelty_search_type, suprb.optimizer.rule.ns.novelty_search_type.LocalCompetition):  # nopep8
                params.rule_discovery__novelty_calculation__novelty_search_type__max_neighborhood_range = trial.suggest_int('rule_discovery__novelty_calculation__novelty_search_type__max_neighborhood_range', 10, 20)  # nopep8
            params.rule_discovery__crossover__crossover_rate = trial.suggest_float('rule_discovery__crossover__crossover_rate', 0.1, 0.5)  # nopep8
        elif params.rule_discovery == 'RandomSearch':
            # RS base
            params.rule_discovery = getattr(suprb.optimizer.rule.rs, params.rule_discovery)()

            params.rule_discovery__n_iter = trial.suggest_int('rule_discovery__n_iter', 1, 5)
        ...
        params.rule_discovery__constraint = trial.suggest_categorical('rule_discovery__constraint', ['MinRange', 'Clip', 'CombinedConstraint'])  # nopep8
        ...
        if isinstance(params.rule_discovery__constraint, suprb.optimizer.rule.constraint.CombinedConstraint):
            ...
            params.rule_discovery__constraint__min_range = suprb.optimizer.rule.constraint.MinRange()

        params.rule_discovery__init = trial.suggest_categorical('rule_discovery__init', ['MeanInit', 'NormalInit', 'HalfnormInit'])  # nopep8
        params.rule_discovery__init = getattr(suprb.rule.initialization, params.rule_discovery__init)()  # nopep8

        if not isinstance(params.rule_discovery__init, suprb.rule.initialization.MeanInit):
            params.rule_discovery__init__sigma = trial.suggest_float('rule_discovery__init__sigma', 0.01, 0.1)  # nopep8

        params.rule_discovery__init__fitness = trial.suggest_categorical('rule_discovery__init__fitness', ['PseudoAccuracy', 'VolumeEmary', 'VolumeWu'])  # nopep8
        ...
        # Selection
        params.rule_discovery__selection = trial.suggest_categorical('rule_discovery__selection', ['Fittest', 'RouletteWheel', 'NondominatedSort', 'Random'])  # nopep8
        params.rule_discovery__selection = getattr(suprb.optimizer.rule.selection, params.rule_discovery__selection)()  # nopep8

        if isinstance(params.rule_discovery, suprb.optimizer.rule.es.ES1xLambda) or \
           isinstance(params.rule_discovery, suprb.optimizer.rule.ns.NoveltySearch):
            # Mutation
            params.rule_discovery__mutation = trial.suggest_categorical('rule_discovery__mutation', ['SigmaRange', 'Normal', 'Halfnorm', 'HalfnormIncrease', 'Uniform', 'UniformIncrease'])  # nopep8
            ...
            if isinstance(params.rule_discovery__mutation, suprb.optimizer.rule.mutation.SigmaRange):
                params.rule_discovery__mutation__mutation = trial.suggest_categorical('rule_discovery__mutation__mutation', ['Normal', 'Halfnorm', 'HalfnormIncrease', 'Uniform', 'UniformIncrease'])  # nopep8
                params.rule_discovery__mutation__mutation = getattr(suprb.optimizer.rule.mutation, params.rule_discovery__mutation__mutation)()  # nopep8

                params.rule_discovery__mutation__low = trial.suggest_float('rule_discovery__mutation__sigma_range__low', 0.001, 0.01)  # nopep8
                params.rule_discovery__mutation__high = trial.suggest_float('rule_discovery__mutation__sigma_range__high', 0.01, 0.1)  # nopep8

                params.rule_discovery__mutation__mutation__sigma = trial.suggest_float('rule_discovery__mutation__mutation__sigma', 0.05, 0.2)  # nopep8
            else:
                params.rule_discovery__mutation__sigma = trial.suggest_float('rule_discovery__mutation__sigma', 0.05, 0.2)  # nopep8

            # Origin Generation
            params.rule_discovery__origin_generation = trial.suggest_categorical('rule_discovery__origin_generation', ['UniformInputOrigin', 'UniformSamplesOrigin', 'Matching', 'SquaredError'])  # nopep8
            params.rule_discovery__origin_generation = getattr(suprb.optimizer.rule.origin, params.rule_discovery__origin_generation)()  # nopep8

            if isinstance(params.rule_discovery__mutation, suprb.optimizer.rule.origin.Matching) or \
               isinstance(params.rule_discovery__mutation, suprb.optimizer.rule.origin.SquaredError):
                params.rule_discovery__origin_generation__use_elitist = trial.suggest_categorical('rule_discovery__origin_generation__use_elitist', [True, False])  # nopep8
