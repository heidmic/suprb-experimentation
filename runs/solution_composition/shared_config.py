...
dataset_params = {
    'combined_cycle_power_plant': {
        ...
        'rule_generation__mutation__sigma_lower': 2.9949,
        'rule_generation__mutation__sigma_prop': 2.7095,
    ...
    'airfoil_self_noise': {
        ...
        'rule_generation__mutation__sigma_lower': 2.8271,
        'rule_generation__mutation__sigma_prop': 2.3035,
        'rule_generation__init': getattr(initialization, 'MeanInit')(),
    ...
    'concrete_strength': {
        'rule_generation__mutation': getattr(mutation, 'UniformIncrease')(),
        'rule_generation__mutation__sigma_lower': 2.8565,
        'rule_generation__mutation__sigma_prop': 2.7411,
        'rule_generation__init': getattr(initialization, 'NormalInit')(),
        'rule_generation__init__sigma_lower': 0.0501,
        'rule_generation__init__sigma_prop': 1.4967,
    ...
    'protein_structure': {
        ...
        'rule_generation__mutation__sigma_lower': 0.0567,
        'rule_generation__mutation__sigma_prop': 0.1027,
        'rule_generation__init': getattr(initialization, 'MeanInit')(),
    ...
    'parkinson_total': {
        'rule_generation__mutation': getattr(mutation, 'UniformIncrease')(),
        'rule_generation__mutation__sigma_lower': 0.4429,
        'rule_generation__mutation__sigma_prop': 1.7216,
        'rule_generation__init': getattr(initialization, 'MeanInit')(),
