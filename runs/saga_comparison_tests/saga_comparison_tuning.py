...
def run(problem: str, solution_composition: str, job_id: str):
    ...
    def suprb_space(trial: Trial, params: Bunch):
        ...
        if solution_composition == "ga":
            ...
            params.solution_composition__selection = getattr(
                suprb.optimizer.solution.saga1.selection, params.solution_composition__selection
            )()  # nopep8
            ...
            params.solution_composition__crossover = getattr(
                suprb.optimizer.solution.saga1.crossover, params.solution_composition__crossover
            )()  # nopep8
            ...
            params.solution_composition__selection = getattr(
                suprb.optimizer.solution.saga2.selection, params.solution_composition__selection
            )()  # nopep8
            ...
            params.solution_composition__crossover = getattr(
                suprb.optimizer.solution.saga2.crossover, params.solution_composition__crossover
            )()  # nopep8
            ...
            params.solution_composition__selection = getattr(
                suprb.optimizer.solution.saga3.selection, params.solution_composition__selection
            )()  # nopep8
            ...
            params.solution_composition__crossover = getattr(
                suprb.optimizer.solution.sas.crossover, params.solution_composition__crossover
            )()  # nopep8
