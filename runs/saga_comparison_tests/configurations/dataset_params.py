...
params_ga = {
    'combined_cycle_power_plant': {
        'rule_discovery__mutation__sigma': 0.6859009365594104,
        'rule_discovery__init__fitness__alpha': 0.02333434010643204,
    ...
    'airfoil_self_noise': {
        'rule_discovery__mutation__sigma': 2.105582184769341, 
        'rule_discovery__init__fitness__alpha': 0.02199191731493414, 
        'solution_composition': ga.GeneticAlgorithm(), 
    ...
    'concrete_strength': {
        'rule_discovery__mutation__sigma': 2.6208139828922463, 
        'rule_discovery__init__fitness__alpha': 0.05454544362563632, 
        'solution_composition': ga.GeneticAlgorithm(), 
    ...
    'protein_structure': {
        'rule_discovery__mutation__sigma': 2.629758097716877, 
        'rule_discovery__init__fitness__alpha': 0.015217998535377692, 
        'solution_composition': ga.GeneticAlgorithm(), 
        'solution_composition__selection': getattr(ga.selection, 'LinearRank')(), 
    ...
    'parkinson_total': {
        'rule_discovery__mutation__sigma': 4.06230815699017, 
        'rule_discovery__init__fitness__alpha': 0.010116533521591767, 
        'solution_composition': ga.GeneticAlgorithm(), 
...
params_saga1 = {
    'combined_cycle_power_plant': {
        'rule_discovery__mutation__sigma': 0.4276687513599815, 
        'rule_discovery__init__fitness__alpha': 0.012714825120382297, 
    ...
    'airfoil_self_noise': {
        'rule_discovery__mutation__sigma': 2.06919494558429, 
        'rule_discovery__init__fitness__alpha': 0.01994191931892904, 
        'solution_composition': saga1.SelfAdaptingGeneticAlgorithm(), 
    ...
    'concrete_strength': {
        'rule_discovery__mutation__sigma': 2.551316064860687, 
        'rule_discovery__init__fitness__alpha': 0.06496686771281035, 
        'solution_composition': saga1.SelfAdaptingGeneticAlgorithm(), 
    ...
    'protein_structure': {
        'rule_discovery__mutation__sigma': 2.854811111764082, 
        'rule_discovery__init__fitness__alpha': 0.01676428321108141, 
        'solution_composition': saga1.SelfAdaptingGeneticAlgorithm(), 
    ...
    'parkinson_total': {
        'rule_discovery__mutation__sigma': 4.213041255163031, 
        'rule_discovery__init__fitness__alpha': 0.010265507041105345, 
        'solution_composition': saga1.SelfAdaptingGeneticAlgorithm(), 
...
params_saga2 = {
    'combined_cycle_power_plant': {
        'rule_discovery__mutation__sigma': 0.7815096036884479, 
        'rule_discovery__init__fitness__alpha': 0.029147681451952713, 
    ...
    'airfoil_self_noise': {
        'rule_discovery__mutation__sigma': 2.131483810985764, 
        'rule_discovery__init__fitness__alpha': 0.016485254492219836, 
        'solution_composition': saga2.SelfAdaptingGeneticAlgorithm(), 
    ...
    'concrete_strength': {
        'rule_discovery__mutation__sigma': 2.4787655878228, 
        'rule_discovery__init__fitness__alpha': 0.02892446714951632, 
        'solution_composition': saga2.SelfAdaptingGeneticAlgorithm(), 
    ...
    'protein_structure': {
        'rule_discovery__mutation__sigma': 1.9513238278283638, 
        'rule_discovery__init__fitness__alpha': 0.010428435367366349, 
        'solution_composition': saga2.SelfAdaptingGeneticAlgorithm(), 
        'solution_composition__n_iter': 124, 
        'solution_composition__selection': getattr(saga2.selection, 'LinearRank')(), 
        'solution_composition__crossover': getattr(saga2.crossover, 'NPoint')(), 
    ...
    'parkinson_total': {
        'rule_discovery__mutation__sigma': 3.8987614190145994, 
        'rule_discovery__init__fitness__alpha': 0.01028134204963452, 
        'solution_composition': saga2.SelfAdaptingGeneticAlgorithm(), 
...
params_saga3 = {
    'combined_cycle_power_plant': {
        'rule_discovery__mutation__sigma': 1.8012460475029914, 
        'rule_discovery__init__fitness__alpha': 0.017014904014171738, 
    ...
    'airfoil_self_noise': 	{
        'rule_discovery__mutation__sigma': 2.234427912602256, 
        'rule_discovery__init__fitness__alpha': 0.01585503400362051, 
        'solution_composition': saga3.SelfAdaptingGeneticAlgorithm(), 
        'solution_composition__n_iter': 106, 
        'solution_composition__selection': getattr(saga3.selection, 'Random')()
    },
    'concrete_strength': {
        'rule_discovery__mutation__sigma': 2.638904587594894, 
        'rule_discovery__init__fitness__alpha': 0.0566214425179575, 
        'solution_composition': saga3.SelfAdaptingGeneticAlgorithm(), 
        'solution_composition__n_iter': 122, 
        'solution_composition__selection': getattr(saga3.selection, 'LinearRank')()
    },
    'protein_structure': {
        'rule_discovery__mutation__sigma': 2.466628786586988, 
        'rule_discovery__init__fitness__alpha': 0.018040735824937, 
        'solution_composition': saga3.SelfAdaptingGeneticAlgorithm(), 
        'solution_composition__n_iter': 62, 
        'solution_composition__selection': getattr(saga3.selection, 'Random')()
    },
    'parkinson_total': {
        'rule_discovery__mutation__sigma': 3.848300857584986, 
        'rule_discovery__init__fitness__alpha': 0.010527440178672106, 
        'solution_composition': saga3.SelfAdaptingGeneticAlgorithm(), 
